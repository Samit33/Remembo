...
import 'package:flutter_svg/svg.dart';
  ...
  const SavesallWidget({super.key});
        ...
        class _SavesallWidgetState extends State<SavesallWidget> {
        @override
      ...
      boxShadow : [BoxShadow(
          color: Color.fromRGBO(81, 142, 246, 0.20000000298023224),
          offset: Offset(0,3),
          blurRadius: 32
      )],
...
Container(
      ...
      child: Stack(
        ...
        top: 7.5,
        left: 20.614883422851562,
        child: Text('9:00 AM', textAlign: TextAlign.left, style: TextStyle(
        color: Color.fromRGBO(255, 255, 255, 1),
        fontFamily: 'Poppins',
        fontSize: 10,
...
Container(
      ...
      child: const Row(
        ...
        children: <Widget>[
          Text('All', textAlign: TextAlign.left, style: TextStyle(
        color: Color.fromRGBO(255, 255, 255, 1),
        fontFamily: 'Campton',
        fontSize: 16,
        letterSpacing: 0 /*percentages not used in flutter. defaulting to zero*/,
...
Text('Active', textAlign: TextAlign.left, style: TextStyle(
        color: Color.fromRGBO(185, 175, 255, 1),
        fontFamily: 'Campton',
        fontSize: 16,
        letterSpacing: 0 /*percentages not used in flutter. defaulting to zero*/,
        fontWeight: FontWeight.normal,
...
Text('Collections', textAlign: TextAlign.left, style: TextStyle(
        color: Color.fromRGBO(185, 175, 255, 1),
        fontFamily: 'Campton',
        fontSize: 16,
        letterSpacing: 0 /*percentages not used in flutter. defaulting to zero*/,
...
Text('Search...', textAlign: TextAlign.left, style: TextStyle(
        color: Color.fromRGBO(130, 136, 152, 1),
        fontFamily: 'Campton',
        fontSize: 16,
        letterSpacing: 0 /*percentages not used in flutter. defaulting to zero*/,
        fontWeight: FontWeight.normal,
...
Container(
      ...
      boxShadow : [BoxShadow(
          color: Color.fromRGBO(108, 86, 242, 0.15000000596046448),
          offset: Offset(0,3),
          blurRadius: 32
      )],
...
Container(
      ...
      color : Color.fromRGBO(241, 239, 254, 1),
      gradient : LinearGradient(
          begin: Alignment(6.123234262925839e-17,1),
          end: Alignment(-1,6.123234262925839e-17),
          colors: [Color.fromRGBO(116, 113, 245, 1),Color.fromRGBO(63, 104, 249, 1)]
...
Container(
      ...
      child: const Row(
        ...
        children: <Widget>[
          Text('What makes AI useful in game development', textAlign: TextAlign.left, style: TextStyle(
...
Container(
      ...
      child: const Row(
        ...
        children: <Widget>[
          Text('AI', textAlign: TextAlign.left, style: TextStyle(
        color: Color.fromRGBO(52, 181, 81, 1),
        fontFamily: 'Campton',
        fontSize: 12,
        letterSpacing: 0 /*percentages not used in flutter. defaulting to zero*/,
...
Container(
      ...
      child: const Row(
        ...
        children: <Widget>[
          Text('Gamedev', textAlign: TextAlign.left, style: TextStyle(
        color: Color.fromRGBO(52, 181, 81, 1),
        fontFamily: 'Campton',
        fontSize: 12,
        letterSpacing: 0 /*percentages not used in flutter. defaulting to zero*/,
...
Container(
      ...
      child: const Row(
        ...
        children: <Widget>[
          Text('< 5min', textAlign: TextAlign.left, style: TextStyle(
        color: Color.fromRGBO(52, 181, 81, 1),
        fontFamily: 'Campton',
        fontSize: 12,
        letterSpacing: 0 /*percentages not used in flutter. defaulting to zero*/,
...
Container(
      ...
      child: const Row(
        ...
        children: <Widget>[
          Text('How to predict root rot in indoor plants.', textAlign: TextAlign.left, style: TextStyle(
        color: Color.fromRGBO(84, 84, 84, 1),
        fontFamily: 'Campton',
        fontSize: 14,
        letterSpacing: 0 /*percentages not used in flutter. defaulting to zero*/,
...
Container(
      ...
      child: Stack(
        ...
        left: 0,
        child: SvgPicture.asset(
        'assets/images/rect7384.svg',
        semanticsLabel: 'rect7384'
      );
      ),Positioned(
        top: 6.75,
        left: 6.750000476837158,
        child: SvgPicture.asset(
        'assets/images/path3343.svg',
        semanticsLabel: 'path3343'
      );
      ),
        ]
      )
...
Container(
      ...
      boxShadow : [BoxShadow(
          color: Color.fromRGBO(201, 121, 150, 0.20000000298023224),
          offset: Offset(0,3),
          blurRadius: 32
      )],
      color : Color.fromRGBO(52, 181, 81, 1),
...
Container(
      ...
      child: Stack(
        ...
        left: 0,
        child: SvgPicture.asset(
        'assets/images/rectangle164571.svg',
        semanticsLabel: 'rectangle164571'
      );
      ),
        ]
      )
...
Container(
      ...
      child: Stack(
        ...
        top: 2.183744430541992,
        left: 1.996805191040039,
        child: SvgPicture.asset(
        'assets/images/vector.svg',
        semanticsLabel: 'vector'
      );
...
SizedBox(
      ...
      child: Stack(
        children: <Widget>[
          Positioned(
        top: 2,
        left: 7.760000228881836,
        child: SvgPicture.asset(
        'assets/images/vector.svg',
        semanticsLabel: 'vector'
      );
      ),Positioned(
        top: 4.082540035247803,
        left: 3.2899999618530273,
        child: SvgPicture.asset(
        'assets/images/vector.svg',
        semanticsLabel: 'vector'
      );
